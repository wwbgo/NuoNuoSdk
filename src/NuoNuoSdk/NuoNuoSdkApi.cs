...
public partial class NuoNuoSdk : INuoNuoSdk
{
    ...
    public Task<GetQrCodeResponse> GetQrCodeAsync(GetQrCodeRequest request)
    {
        return ExecuteAsync<GetQrCodeRequest, GetQrCodeResponse>(request);
    }
    ...
    public Task<VerifyCompleteResponse> VerifyCompleteAsync(VerifyCompleteRequest request)
    {
        return ExecuteAsync<VerifyCompleteRequest, VerifyCompleteResponse>(request);
    }
    ...
    public Task<GetCreditLineResponse> GetCreditLineAsync(GetCreditLineRequest request)
    {
        return ExecuteAsync<GetCreditLineRequest, GetCreditLineResponse>(request);
    }
    ...
    public Task<GetCertificationStatusResponse> GetCertificationStatusAsync(GetCertificationStatusRequest request)
    {
        return ExecuteAsync<GetCertificationStatusRequest, GetCertificationStatusResponse>(request);
    }
}
